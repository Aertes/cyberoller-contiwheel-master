  ...
  export default {
    created () {
      ...
      this.$watch('form.name', function (value) {
        let checkKey = checkData(value, 'notNull', 'notSpace', 'notSpace', 'moreThan20', 'pwdReg')
    ...
    computed: {
      isCanSub () {
        ...
        let isSub = true
        for (let key of ['name', 'email', 'password', 'rePassword', 'phone']) {
