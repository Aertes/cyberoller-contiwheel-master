  ...
  export default {
    ...
    mounted () {
      ...
      Promise.all([getData(xhrUrls.SEARCH_PRODUCT_LIST, {
        ...
        this.form.img_length = this.image.img_length
        this.form.img_previwe = this.image.img_previwe
        this.form.img_format = this.image.img_format
        this.form.category = this.image.category
        this.type_name = this.set[this.image.category].name
        this.form.img_label = this.image.img_label.split(' ')[0]
        this.form.description = this.image.description
        this.loading = false
        this.img_type_1 = this.image.img_type === 'Product Image'
        this.img_type_2 = !this.img_type_1
        this.img_label1 = this.image.img_label.split(' ')[1]
        this.img_label2 = this.image.img_label.split(' ')[2]
        this.img_label_name1 = this.form.img_label && this.set[this.form.img_label].name
        this.img_label_name2 = this.img_label1 && this.set[this.img_label1].name
        this.img_label_name3 = this.img_label2 && this.set[this.img_label2].name
      })
    },
    methods: {
      blur (key) {
